...
public class InputTemplate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  View 객체 획득
        view_photo = findViewById(R.id.photo);
        view_memory_or_promise = findViewById(R.id.memory_or_promise);
        view_memory = findViewById(R.id.btn_memory);
        view_promise = findViewById(R.id.btn_promise);
        view_category = findViewById(R.id.category);
        view_check_stayed_time = findViewById(R.id.check_stayed_time);
        view_stayed_time = findViewById(R.id.stayed_time);
        view_promised_time = findViewById(R.id.promised_date_time);
        view_memo = findViewById(R.id.memo);
        view_check_memory = findViewById(R.id.checked_memory);
        view_check_promise = findViewById(R.id.checked_promise);
        view_btn_setAlarm = findViewById(R.id.btn_setAlarm);
        ...
        view_photo.setOnClickListener(new ImageView.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view_photo.getDrawable() == null) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(InputTemplate.this);
                    ...
                    builder.setTitle("등록된 사진이 있습니다")
                            .setNegativeButton("다른 사진으로 바꾸기", new DialogInterface.OnClickListener() {
                                ...
                                //  다른 사진으로 바꾸기
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    AlertDialog.Builder builder_new_photo = new AlertDialog.Builder(InputTemplate.this);
    ...
    private void setMemory() {
        ...
        dialog_stayed_date_time = new Dialog(InputTemplate.this);
    ...
    private void setPromise() {
        ...
        dialog_promised_date_time = new Dialog(InputTemplate.this);
